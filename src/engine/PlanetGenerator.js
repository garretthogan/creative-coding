...
const surfaceGeometry = new THREE.SphereGeometry(15, 32, 16).toNonIndexed();
...
export class PlanetGenerator {
	constructor() {
		this.initPlanetGenerator = this.initPlanetGenerator.bind(this);
		this.animate = this.animate.bind(this);
		this.render = this.render.bind(this);
		this.startPlanetGenerator = this.startPlanetGenerator.bind(this);
		this.onWindowResize = this.onWindowResize.bind(this);
		this.updatePlanetGenerator = this.updatePlanetGenerator.bind(this);

		this.container = document.getElementById('generate-container');
	}
	...
	render() {
		this.updatePlanetGenerator();
		// add fps stuff to this class
